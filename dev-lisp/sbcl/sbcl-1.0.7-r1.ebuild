...
src_unpack() {
	...
	# customizing SBCL version
	# see http://tinyurl.com/yreta9
	local my_repo_name="gentoo-lisp-overlay"
	echo ";;; Auto-generated by Gentoo" > "${S}/version.lisp-expr"
	echo "\"${PV}.${my_repo_name}.${PR/r/}\"" >> "${S}/version.lisp-expr"
