...
HOMEPAGE="http://www-2.cs.cmu.edu/afs/cs/project/ai-repository/ai/lang/lisp/code/testing/${PN}/ http://packages.debian.org/unstable/devel/cl-${PN}.html http://www.cliki.net/${PN}"
...
src_install() {
	common-lisp-install ${PN}.lisp "${FILESDIR}"/${PN}.asd
